...
const COMMANDS = [
  { group: 'Navigate', items: [
    ...
    { id: 'lists', label: 'Lists', description: 'Groups you put contacts into, for targeted sends.', keywords: ['group', 'segment', 'filter', 'organize', 'list'], shortcut: 'g l', action: '/dashboard/lists', icon: PieChart },
  ...
  { group: 'Actions', items: [
    ...
    { id: 'new-list', label: 'New List', description: 'Create a list to organize your contacts.', keywords: ['new segment', 'create group', 'new list'], shortcut: 'n l', action: 'create-list' },
